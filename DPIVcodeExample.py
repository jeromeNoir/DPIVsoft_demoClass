...
# Load first pair of images to initialize GPU
name_img_1 = os.path.join(dirImg, files[0])
name_img_2 = os.path.join(dirImg, files[1])
...
for i in range(0, len(files) - 1, 2):
    ...
    saveName = os.path.join(dirRes, f"gpu_field_{i // 2:03d}")
